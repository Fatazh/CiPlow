...
if (import.meta.client) {
  ...
  if (!isInstalled) {
    ...
    window.addEventListener('beforeinstallprompt', (e: Event) => {
      ...
      const dismissed = localStorage.getItem('pplow-pwa-dismissed')
      if (!dismissed) {
...
const dismiss = () => {
  show.value = false
  localStorage.setItem('pplow-pwa-dismissed', Date.now().toString())
}
</script>
...
<template>
  ...
  >
    <div
      v-if="show"
      class="
        fixed bottom-20 left-3 right-3 z-[80]
    ...
    >
      <!-- Gradient accent bar -->
      <div class="h-1 bg-gradient-to-r from-emerald-400 via-primary-500 to-blue-500" />
      ...
      <div class="p-4">
        <div class="flex items-start gap-3">
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-[11px] text-gray-400 dark:text-gray-500 mt-0.5 leading-relaxed">
              Akses cepat dari home screen, tampilan fullscreen, bisa offline!
            </p>
          </div>
