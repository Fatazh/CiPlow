    ...
    <div class="page-wrapper">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex flex-col justify-center min-w-0">
          <p class="text-xs font-medium text-gray-400 dark:text-gray-500 truncate">
            {{ todayLabel }}
          </p>
          <h1 class="text-sm font-semibold text-gray-800 dark:text-gray-100 flex items-center gap-1 truncate">
            {{ greeting }},
            <span class="text-gradient font-bold">{{ firstName }}</span>
            <span class="text-base leading-none">{{ greetingEmoji }}</span>
          </h1>
        </div>
        ...
        <div class="flex items-center gap-2 flex-shrink-0">
          ...
          <button
            class="
              relative btn-icon rounded-full
