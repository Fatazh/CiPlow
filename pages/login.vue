...
const handleLogin = async () => {
  ...
  try {
    ...
    error.value = err?.data?.message ?? 'Login gagal. Coba lagi.'
  } finally {
    loading.value = false
  }
}
...
<template>
  <div class="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-blue-50 dark:from-surface-950 dark:via-surface-900 dark:to-surface-950 flex items-center justify-center px-4">
    <div class="w-full max-w-sm">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-extrabold text-gray-800 dark:text-gray-100">Selamat Datang</h1>
        <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">Masuk ke akun PPLow kamu</p>
      </div>
      ...
      <p class="text-center text-sm text-gray-400 dark:text-gray-500 mt-6">
        Belum punya akun?
        <NuxtLink to="/register" class="font-semibold text-emerald-500 hover:text-emerald-600 transition-colors">
          Daftar sekarang
        </NuxtLink>
      </p>
