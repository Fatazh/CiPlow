...
<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-emerald-50 dark:from-surface-950 dark:via-surface-900 dark:to-surface-950 flex items-center justify-center px-4 py-8">
    <div class="w-full max-w-sm">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-extrabold text-gray-800 dark:text-gray-100">Buat Akun Baru</h1>
        <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">Mulai kelola keuanganmu hari ini</p>
      </div>

      <!-- Form Card -->
      <div class="
        bg-white dark:bg-surface-900
        rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-black/30
      ...
      ">
        ...
        <form @submit.prevent="handleRegister" class="space-y-4">
          ...
          <div>
            ...
            <p v-if="passwordMismatch" class="text-[11px] text-rose-500 mt-1 font-semibold">
      ...
      <p class="text-center text-sm text-gray-400 dark:text-gray-500 mt-6">
        Sudah punya akun?
        <NuxtLink to="/login" class="font-semibold text-emerald-500 hover:text-emerald-600 transition-colors">
          Masuk di sini
        </NuxtLink>
      </p>

      <p class="text-center text-[11px] text-gray-300 dark:text-gray-700 mt-8">
        PPLow v1.0 — Personal Budget Tracker
      </p>
    </div>
  </div>
</template>
